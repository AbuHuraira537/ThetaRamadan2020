...
namespace ThetaRamadan2020.Controllers
{
    public class Categories1Controller : Controller
    {
        ...
        public Categories1Controller(thetaramdan2020Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description,Image,TotalItems")] Categories categories)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description,Image,TotalItems")] Categories categories)
        {
            if (id != categories.Id)
            {
                return NotFound();
